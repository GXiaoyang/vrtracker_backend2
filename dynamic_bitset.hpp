...
// below is my HACKED_BITSET version of the dynamic bitset making modifications
// wrapped in #define HACKED_BITSET
//	* does not require any other boost libs
//  * the bitset resizes if you write to a bit 
// builds on visual studio

#define HACKED_BITSET
...
#ifdef HACKED_BITSET
//
// bunch of stuff to avoid including any boost dependencies
//
#define BOOST_NOEXCEPT noexcept
#define BOOST_STATIC_ASSERT(...) static_assert(__VA_ARGS__, #__VA_ARGS__)
#define BOOST_STATIC_CONSTANT(type, assignment) static const type assignment
#define BOOST_DYNAMIC_BITSET_PRIVATE private
#define BOOST_WORKAROUND(a,b) false
...
#ifdef HACKED_BITSET
		// sean: added this to auto resize
		if (pos >= m_num_bits)
		{
			resize(pos+1);
		}
