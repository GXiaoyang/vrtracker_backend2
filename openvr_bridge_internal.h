#include <openvr.h>
class VRSystemBridge : public vr::IVRSystem
{
public:
  ...
  void SetSYSI(vr::IVRSystem *sysi) { m_sysi = sysi; }
private: 
	vr::IVRSystem *m_sysi;

};
class VRExtendedDisplayBridge : public vr::IVRExtendedDisplay
{
public:
  ...
  void SetEXDI(vr::IVRExtendedDisplay *exdi) { m_exdi = exdi; }
private:
	vr::IVRExtendedDisplay *m_exdi;
};

class VRTrackedCameraBridge : public vr::IVRTrackedCamera
{
public:
  ...
  void SetTACI(vr::IVRTrackedCamera *taci) { m_taci = taci;  }
private:
	vr::IVRTrackedCamera *m_taci;
};
class VRApplicationsBridge : public vr::IVRApplications
{
public:
  ...
  void SetAPPI(vr::IVRApplications *appi) { m_appi = appi; }
private:
	IVRApplications *m_appi;
};
class VRChaperoneBridge : public vr::IVRChaperone
{
public:
  ...
  void SetCHAPI(vr::IVRChaperone *chapi) { m_chapi = chapi; }
private:
	vr::IVRChaperone *m_chapi;
};
class VRChaperoneSetupBridge : public vr::IVRChaperoneSetup
{
public:
  ...
  void SetCHAPSI(vr::IVRChaperoneSetup *chapsi) { m_chapsi = chapsi; }
private:
	vr::IVRChaperoneSetup *m_chapsi;
};
class VRCompositorBridge : public vr::IVRCompositor
{
public:
  ...
  void SetCOMPI(vr::IVRCompositor *compi) { m_compi = compi; }
private:
	vr::IVRCompositor *m_compi;
  
};
class VROverlayBridge : public vr::IVROverlay
{
public:
  ...
  void SetOVI(vr::IVROverlay *ovi) { m_ovi = ovi; }
private:
	vr::IVROverlay *m_ovi;
};
class VRRenderModelsBridge : public vr::IVRRenderModels
{
public:
  ...
  void SetREMI(vr::IVRRenderModels *remi) { m_remi = remi; }
private:
	vr::IVRRenderModels *m_remi;
};
class VRNotificationsBridge : public vr::IVRNotifications
{
public:
  ...
  void SetNOTI(vr::IVRNotifications *noti) { m_noti = noti; }
private:
	vr::IVRNotifications *m_noti;
};

class VRSettingsBridge : public vr::IVRSettings
{
public:
  ...
  void SetSETI(vr::IVRSettings *seti) { m_seti = seti; }
private:
	vr::IVRSettings *m_seti;
};
class VRScreenshotsBridge : public vr::IVRScreenshots
{
public:
  ...
  void SetSCREENI(vr::IVRScreenshots *screeni) { m_screeni = screeni; }
private:
	vr::IVRScreenshots *m_screeni;
};
class VRResourcesBridge : public vr::IVRResources
{
public:
  ...
  void SetRESI(vr::IVRResources *resi) { m_resi = resi; }
private:
	vr::IVRResources *m_resi;
};
